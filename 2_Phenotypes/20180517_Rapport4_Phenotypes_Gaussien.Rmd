...
list.of.packages <- c( "gridExtra", "kableExtra", "ggrepel", "knitr", "DT", "pheatmap")
...
read_chunk("~/workspace/AnalysisSteph/2_Phenotypes/Input/pheno_analysis_gaussien.R")
read_chunk("~/workspace/AnalysisSteph/2_Phenotypes/Input/summary.R")
...
Deux indicateurs sont définis par la suite : l'indicateur de médiane $I_M$ et l'indicateur de variation $I_V$ définis tels quel : 
- $I_M = mediane_4 - mediane_1$
- $I_V = mad_4 - mad_1$
