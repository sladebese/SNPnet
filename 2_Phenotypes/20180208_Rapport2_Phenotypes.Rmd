...
list.of.packages <- c( "gridExtra", "kableExtra", "ggrepel", "knitr")
...
read_chunk("~/workspace/AnalysisSteph/2_Phenotypes/Input/pheno_analysis_01.R")
...
#### Distribution des individus par phénotypes
